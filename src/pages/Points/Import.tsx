...
import { importPointsDates } from 'store/slices/point/thunks'
...
export const Import: FC = () => {
  ...
  const handleSubmit = () => {
    ...
    dispatch(importPointsDates(data)).then((e) => {
  ...
  return (
    <>
      ...
      >
        Импорт расписания точек доставки
      </Button>
      {open && (
        <Dialog
          open={open}
          ...
          maxWidth="md"
        >
          <DialogTitle>Импорт расписания точек доставки</DialogTitle>
          <DialogContent>
