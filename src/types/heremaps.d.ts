...
declare namespace H {
  ...
  namespace clustering {
    ...
    interface ICluster {
       ...
       */
      forEachDataPoint(
        callback: (noise: H.clustering.INoisePoint) => void
      ): void
  ...
  namespace data {
    ...
    namespace geojson {
      ...
      class Reader extends H.data.AbstractReader {
        ...
        constructor(
          opt_url?: string,
          opt_options?: H.data.geojson.Reader.Options
        )
  ...
  namespace geo {
    ...
    class Polygon extends H.geo.AbstractGeometry {
      constructor(
        ...
        opt_interiors?: H.geo.LineString[]
      )
  ...
  namespace map {
    ...
    interface IControl {
      ...
      endControl(
        ...
        opt_adjustView?: (data: H.map.ViewModel.ILookAtData) => void
      ): void
    }
    ...
    class Polygon extends H.map.GeoShape {
       ...
       */
      constructor(
        geometry: H.geo.LineString | H.geo.Polygon | H.geo.MultiPolygon,
        opt_options?: H.map.Polygon.Options
      )
  ...
  namespace service {
    ...
    class Platform {
       ...
       */
      getTrafficService(
        opt_options?: H.service.traffic.Service.Options
  ...
  namespace ui {
    ...
    namespace UI {
      ...
      interface Options {
        ...
        distancemeasurement?:
          | (H.ui.DistanceMeasurement.Options | boolean)
          | undefined
